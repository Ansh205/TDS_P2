...
token="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"
...
def GA1_13(question):
    ...
    return "https://raw.githubusercontent.com/Ansh205/Test/main/email.json"
...
def GA2_3(question):
    ...
    time.sleep(15)
    return "https://Ansh205.github.io/website/?v=5"
...
async def GA2_6_file(file: UploadFile = File(...)):
    ...
    response = github_write_file(
        token, "Ansh205/api", file_path_on_github, file_content)
...
async def GA2_9_file(file: UploadFile = File(...)):
    ...
    # Upload the file to GitHub
    response = github_write_file(
        token, "Ansh205/tds_ga2_9", file_path_on_github, file_content)
...
def GA2_7(question):
    ...
    trigger_github_workflow(
        token=token, repo="Ansh205/Test", workflow_file="Daily_Commit.yml")
    time.sleep(15)
    return "https://github.com/Ansh205/Test"
